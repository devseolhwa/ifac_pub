!function(a) {
    ...
    b.prototype.activateADA = function() {
        var a = this;
        a.$slideTrack.find(".slick-active").removeAttr('tabindex').find("a, input, button, select").removeAttr('tabindex')
    }
    ,
    ...
    b.prototype.setSlideClasses = function(a) {
        ...
        b.options.slidesToShow == b.options.slidesToScroll && b.slideCount - a < b.options.slidesToShow ? d.slice(e - (b.options.slidesToShow - f), e + f).addClass("slick-active") : d.slice(e, e + b.options.slidesToShow).addClass("slick-active")),
